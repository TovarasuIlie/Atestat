...
<?php if(isset($_GET['msg']) && $_GET['msg'] == 'error') { ?>
  ...
  <?php if(isset($_GET['msg']) && $_GET['msg'] == 'alreadyverified') { ?>
  <script>
      $(document).ready(function(){
          $("#alreadyverifiedmodal").modal('show');
      });
  </script>
<?php } ?>
  ...
  function goTop() {
	...
	<body>
      ...
      <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-gray">
        <a class="navbar-brand" href="index.php"><img src="img/logo.png" height="30px" width="140px" title="VolvoFAN.ro"></a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <center>
          <i class="fas fa-fw fa-9x fa-exclamation-triangle"></i>
          <p style="font-weight: 900; font-size: 30px; margin-top: 10px;">A aparut o eroare. Va rugam sa reincercati.</p>
        </center>
        </div>
      </div>
    </div>
...
<div class="modal fade" id="alreadyverifiedmodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
      ...
      <div class="modal-body">
        ...
        <center>
          <i class="fas fa-fw fa-9x fa-exclamation-triangle"></i>
          <p style="font-weight: 900; font-size: 30px; margin-top: 10px;">Acest cont este deja verificat.</p>
        </center>
        </div>
      </div>
    </div>
		...
		<div class="modal-content" style="border-radius: 5px;">
			<div class="modal-header" style="background-color: #4d4d4d;">
				...
				<div class="modal-body">
					...
					<small><b><label class="mr-sm-2">Parola: </label><a href="recoverpassword.php">Ti-ai uitat parola?</a></b></small>
    ...
    <span class="sr-only">Next</span>
     ...
     <div class="container marketing">
        ...
        <div class="row featurette">
          <div class="col-md-7">
            <h2 class="featurette-heading">Ideile care schimbă lumea sunt de multe ori cele mai controversate. <span class="text-muted">Încă un milion de vieți.</span></h2>
            <p class="lead">După ce am inventat centura de siguranță cu prindere în 3 puncte, am înfruntat un val de critici. De atunci, acest sistem a salvat peste un milion de vieți. Acum este timpul pentru pasul următor. Pentru siguranța tuturor. Cu ajutorul funcțiilor noi de siguranță și al celor existente, suntem deciși să salvăm încă un milion de vieți.</p>
            <a href="history.php?view=inovations">Descoperă mai multe despre siguranța mașinilor <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
          </div>
          <div class="col-md-5">
            <img class="featurette-image img-fluid mx-auto" src="img/seatbelt.jpg" alt="Volvo Seat Belt" style="border-radius: 4px;">
          </div>
        </div>
        ...
        <div class="row featurette">
          <div class="col-md-7 order-md-2 edittextboxleft">
            <h2 class="featurette-heading">Limitarea de <span class="text-muted">viteză.</span></h2>
            <p class="lead editposttextbox">Pentru a lansa un semnal de alarmă asupra pericolelor vitezei în exces, am limitat în 2020 viteza tuturor mașinilor noastre noi la 180 km/h. De asemenea, cercetăm modul în care controlul inteligent al vitezei și limitarea zonală, ar putea reduce pe viitor viteza în mod automat, în apropierea școlilor și spitalelor.</p>
          </div>
          <div class="col-md-5 order-md-1">
            <img class="featurette-image img-fluid mx-auto editpos" src="img/speedlimit.jpg" data-src="holder.js/500x500/auto" alt="Volvo Speed Limit">
          </div>
        </div>
        ...
        <div class="row featurette">
          <div class="col-md-7 edittextboxright">
            <h2 class="featurette-heading">Camere de monitorizare <span class="text-muted">a șoferului.</span></h2>
            <p class="lead">Pentru a ajuta la prevenirea distragerii atenției în trafic și a condusului sub influența alcoolului, lucrăm la noi soluții pentru interiorul mașinilor. Camerele de monitorizare a șoferului, împreună cu alți senzori, vor permite mașinii să intervină când un șofer distras sau în stare de ebrietate este în pericol de moarte sau de accidentare gravă.</p>
          </div>
          <div class="col-md-5">
            <img class="featurette-image img-fluid mx-auto editpos2" src="img/drivercam.jpg" alt="Volvo Driver Cams" style="border-radius: 4px;">
          </div>
        </div>
        ...
        <div class="row featurette">
          <div class="col-md-7 order-md-2 edittextboxleft">
            <h2 class="featurette-heading">Tehnologia <span class="text-muted">Highway pilot.</span></h2>
            <p class="lead">Cu ajutorul senzorilor LiDAR, următoarea generație de mașini Volvo va fi pregătită din punct de vedere hardware pentru condusul autonom. În plus, în timp, vom perfecționa actualizările software pentru a oferi un mod de condus complet autonom pe autostradă.</p>
          </div>
          <div class="col-md-5 order-md-1">
            <img class="featurette-image img-fluid mx-auto editpos3" src="img/highwaypilot.jpg" alt="Volvo Speed Limit" style="border-radius: 4px;">
          </div>
        </div>
        ...
        <div class="row featurette">
          <div class="col-md-7 edittextboxright">
            <h2 class="featurette-heading">Cheia de siguranță <span class="text-muted">de siguranță</span></h2>
            <p class="lead">Am introdus recent funcția Care Key, destinată controlării vitezei în exces. Prin Care Key, posesorii Volvo pot stabili o limită de viteză pentru situațiile în care împrumută mașina unui începător sau unui șofer cu mai puțină experiență, pentru a-i asigura un condus mai sigur.</p>
          </div>
          <div class="col-md-5">
            <img class="featurette-image img-fluid mx-auto editpos4" src="img/safetykey.jpg" alt="Volvo Seat Belt" style="border-radius: 4px;">
          </div>
        </div>
