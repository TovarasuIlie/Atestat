...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 11, 2021 at 08:02 PM
...
(6, 'NicuADMIN', 'Administratorul <b>NicuADMIN</b> ti-a marcat Bug Report-ul <b>Testare noul bug report</b> ca si <b style=\"color: #33cc33;\">Rezolvat</b>. Multumim pentru ajutorul acordat!', 0),
(17, 'NicuADMIN', 'Administratorul <b>NicuADMIN</b> ti-a marcat Report-ul impotriva topicului <b>Oficial primul topic!</b> ca si <b style=\"color: #33cc33;\">Rezolvat</b>.', 0),
...
(21, 'ElProgramatorPrangate', 'Administratorul <b>NicuADMIN</b> ti-a acordat functia de <span class=\"badge badge-success\">Administrator</span>. Felicitari!', 0),
(22, 'ElProgramatorPrangate', 'Administratorul <b>NicuADMIN</b> te-a eliminat din echipa administrativa', 0),
(23, 'ElProgramatorPrangate', 'Administratorul <b>NicuADMIN</b> ti-a acordat functia de <span class=\"badge badge-primary\">Modelator</span>. Felicitari!', 0),
(24, 'ElProgramatorPrangate', 'Administratorul <b>NicuADMIN</b> te-a eliminat din echipa administrativa', 0),
(25, 'ElProgramatorPrangate', 'Administratorul <b>NicuADMIN</b> ti-a acordat functia de <span class=\"badge badge-primary\">Modelator</span>. Felicitari!', 0),
(26, 'ElProgramatorPrangate', 'Administratorul <b>NicuADMIN</b> ti-a acordat functia de <span class=\"badge badge-primary\">Modelator</span>. Felicitari!', 0),
(27, 'ElProgramatorPrangate', 'Administratorul <b>NicuADMIN</b> ti-a acordat functia de <span class=\"badge badge-success\">Administrator</span>. Felicitari!', 0),
(28, 'ElProgramatorPrangate', 'Administratorul <b>NicuADMIN</b> te-a eliminat din echipa administrativa', 0),
(29, 'ElProgramatorPrangate', 'Administratorul <b>NicuADMIN</b> ti-a acordat functia de <span class=\"badge badge-success\">Administrator</span>. Felicitari!', 0);
...
INSERT INTO `logs` (`id`, `iduserlog`, `userlog`, `logtext`, `logdate`) VALUES
(1, 21, 'NicuADMIN', '<b>NicuADMIN</b> a creat topicul <b>asfa</b>.', '2021-01-10 20:54:33'),
(8, 21, 'NicuADMIN', 'Administratorul <b>NicuADMIN</b> l-a promovat pe <b>ElProgramatorPrangate</b> al functia de <span class=\"badge badge-success\">Administrator</span>.', '2021-01-10 21:37:57'),
(9, 21, 'NicuADMIN', 'Administratorul <b>NicuADMIN</b> i-a scos functia lui <b>ElProgramatorPrangate</b>.', '2021-01-10 21:38:15'),
(10, 21, 'NicuADMIN', 'Administratorul <b>NicuADMIN</b> l-a promovat pe <b>ElProgramatorPrangate</b> al functia de <span class=\"badge badge-success\">Administrator</span>.', '2021-01-10 21:38:19'),
(14, 21, 'NicuADMIN', 'Administratorul <b>NicuADMIN</b> a sters contul <b>Fuego</b>.', '2021-01-10 21:50:21');
...
(2, 'NicuADMIN', 'Test', '13213', '<p>asfasf</p>\r\n', 0, 0, '2021-01-09 23:36:17'),
(4, 'NicuADMIN', 'asfa', 'asfasf', '<p>asfaf</p>\r\n', 0, 0, '2021-01-10 20:54:33');
...
(23, 'ElProgramatorPrangate', '$2y$10$qptUTh6sPJjxjLKNesTJZOBEPHgv48TWJr1dErf9T02vDKdLL4Pn.', 'sfpetru@gmail.com', '::1', 'Teo', 'Jmenuru', 18, 'Brasov', '2020-12-27 19:05:48', 2, '0000-00-00', 1, 'profileimg23.ElProgramatorPrangate.1392053993.jpg', '', '', ''),
...
(1, 0, 'Volvo FAN \"Home\"', 713),
(2, 0, 'Volvo FAN \"Istoria Marcii\"', 174),
(3, 0, 'Volvo FAN \"De ce Volvo?\"', 33),
(4, 0, 'Volvo FAN \"Contact\"', 42),
(6, 1, 'Volvo FAN Topic \"Oficial primul topic!\"', 23),
(7, 2, 'Volvo FAN Topic \"Test\"', 3),
(8, 3, 'Volvo FAN Topic \"asfa\"', 0),
(9, 4, 'Volvo FAN Topic \"asfa\"', 1);
